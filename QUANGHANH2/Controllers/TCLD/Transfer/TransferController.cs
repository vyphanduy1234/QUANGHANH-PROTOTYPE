...
namespace QUANGHANHCORE.Controllers.TCLD
{
    public class TransferController : Controller
    {
        ...
        public ActionResult GetData(String selectListJson, String searchMa, String searchTen, String phongbanSearch, String chucVuSearch)
        {
            ...
            ")" + " where  A.MaNV like '%' + @maNV + '%' and   A.Ten like '%' + @tenNV + '%' and   B.department_id like '%' + @maPhongBan + '%' and A.MaCongViec like '%' + @maCongViec + '%'"
            + " and A.MaTrangThai<>2";

                if (phongbanSearch.Equals("-1"))
                {
                    phongbanSearch = "";
                }
                if (chucVuSearch.Equals("-1"))
                {
                    chucVuSearch = "";
                }
                ...
                listNhanVien = listNhanVien.Skip(start)
